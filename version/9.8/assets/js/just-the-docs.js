...
function initSearch() {
  ...
  request.open('GET', '/kdrs-search-and-view-docs/version/9.8/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/kdrs-search-and-view-docs/version/9.8/assets/css/just-the-docs-' + theme + '.css');
}
