...
function initSearch() {
  ...
  request.open('GET', '/kdrs-search-and-view-docs/version/1.4/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/kdrs-search-and-view-docs/version/1.4/assets/css/just-the-docs-' + theme + '.css');
}
