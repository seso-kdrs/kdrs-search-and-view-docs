...
function initSearch() {
  ...
  request.open('GET', '/test-kdrs-innsyn-docs/version/i.o/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/test-kdrs-innsyn-docs/version/i.o/assets/css/just-the-docs-' + theme + '.css');
}
